...
/**
 * Backtest version of orderWatcherBurst.js breakeven + trailing rules.
 *
 * Inputs:
 * - side: 'LONG' | 'SHORT'
 * - entry: number
 * - initialSl: number (the SL at trade open)
 * - currentSl: number
 * - price: current mark/last price (we use candle close by default)
 * - env: process.env (implicit)
 *
 * Returns:
 * - { newSl: number|null, reason: string|null, lockR: number|null }
 */
